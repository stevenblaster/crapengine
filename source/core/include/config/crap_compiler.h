...
#ifndef CRAP_DL
#define CRAP_EXE_TO_DLL CRAP_API_EXPORT
#define CRAP_DLL_TO_EXE CRAP_API_IMPORT
#else
#define CRAP_EXE_TO_DLL CRAP_API_IMPORT
#define CRAP_DLL_TO_EXE CRAP_API_EXPORT
#endif //CRAP_DL
