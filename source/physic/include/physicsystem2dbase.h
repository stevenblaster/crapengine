...
#ifndef PHYSIC_INCLUDE_PHYSICSYSTEM2DBASE_H_
#define PHYSIC_INCLUDE_PHYSICSYSTEM2DBASE_H_

#include "utilities.h"

class PhysicSystem2DBase
{
public:
	PhysicSystem2DBase( void ) {}
	virtual ~PhysicSystem2DBase( void ) {}
...
#endif /* PHYSIC_INCLUDE_PHYSICSYSTEM2DBASE_H_ */
