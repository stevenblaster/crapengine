...
#ifndef PLUGINS_COMPONENTS_INCLUDE_KEYBOARDLISTENER_H_
#define PLUGINS_COMPONENTS_INCLUDE_KEYBOARDLISTENER_H_
...
#endif /* PLUGINS_COMPONENTS_INCLUDE_KEYBOARDLISTENER_H_ */
